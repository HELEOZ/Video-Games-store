...
import hero1 from "../../img/Fondo-1.png";
import hero2 from "../../img/Fondo-1.png";
                ...
                <div className="fag-caption-cell">
                  <Container>
                    <Row>
                      <Col sm={12}>
                        <div className="slider-text">
                          <h3>Batalla Extrema</h3>
                          <h2>Batallas Realistas</h2>
                          <Link
                            to="/"
                            onClick={openModal}
                            className="popup-youtube fag-btn-outline"
