            ...
            <Col sm={12}>
              <div className="site-heading">
                <h2 className="heading_animation">
                  Próximo <span>Partido</span>
                </h2>
                <p>
                Este es nuestro momento, nuestro desafío y nuestra oportunidad de brillar. 
                Así que, saltemos al campo con confianza y luchemos juntos por el triunfo. 
                ¡Vamos a escribir nuestra historia de éxito en este próximo partido!
                </p>
              </div>
            </Col>
          </Row>
